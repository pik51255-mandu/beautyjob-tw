...
**결정(2026-08-21): 2026-11 대만 도착 후 확보.** 원격 회선으로는 위 두 경로 모두 막혀 있어
재시도 비용만 든다. 선후님이 현지에 도착해 대만 회선에서 직접 받는 쪽으로 정리했다.
그때까지 라인 B 와 0-4 는 보류하고, 원격 재시도는 하지 않는다.

**도착 후 조치(사람)**: 브라우저에서 아래 중 하나로 `067003A13`(版次 V114112113) PDF를 받아
...
**현재 상태: 전량 보류 — PDF 를 2026-11 대만 도착 후 확보하기로 결정(2026-08-21).**
...
1. **05 題庫 PDF: 2026-11 대만 도착 후 재시도** — 현지 회선 문제로 원격 확보 불가.
   선후님 대만 체류 중 현지 회선으로 받는다(2026-08-21 결정). 그때까지 재시도하지 않는다.
2. **라인 B(기출 해설) 전량 보류** — 1번에 걸려 있다. slug 확정·집필 모두 PDF 파싱 후.
   0-4(단원·문항수 확정)도 같이 묶여 보류.
